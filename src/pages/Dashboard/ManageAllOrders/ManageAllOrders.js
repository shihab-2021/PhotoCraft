...
export default function ManageAllOrders() {
  ...
  React.useEffect(() => {
    fetch("https://photo-craft.vercel.app/allBooking")
      .then((res) => res.json())
                ...
                {userOrders?.map((userOrder) => (
                  ...
                  >
                    ...
                    <TableCell align="center">
                      {userOrder?.product?.product_name}
                    </TableCell>
                    <TableCell align="center">
                      $ {userOrder?.product?.product_price}
                    </TableCell>
                    <TableCell align="center">{userOrder?.address}</TableCell>
                    <TableCell align="center">
